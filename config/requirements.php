...
#OJO ERROR DE VERSION DE ICU
    #Se encuentra instalada la version 65.1 pero aun así exije actualizarla en el siguiente if
    #por lo cual se comenta omitiendo esta validacion, de este modo ya es posible cargar el proyecto 
    #en el navegador
