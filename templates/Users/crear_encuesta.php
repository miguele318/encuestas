...
<body>
    ...
    <div class="container datos">
        <div class="text-center bg-light" id="info">
			...
			<?= $this->Form->create() ?>            
            <div id="datos"><label class="d-inline-flex"><strong>Nombre de la encuesta:&nbsp;</strong></label><input class="border rounded form-control-sm" type="text" style="margin: 5px;width: 45%;">
                <p></p><label class="d-inline-flex"><strong>Pagina WEB:&nbsp;&nbsp;</strong></label><input class="border rounded form-control-sm" type="text" style="margin: 5px;width: 64%;"><i class="fa fa-remove"></i>
                <p></p><label class="d-inline-flex"><strong>Fecha fin:&nbsp;&nbsp;</strong></label><input type="date">
                <p></p><label class="d-inline-flex"><strong>Mensaje para los encuestados:&nbsp;</strong></label><textarea class="border rounded form-control-lg" autocomplete="on" autofocus="" spellcheck="true" cols="30" style="width: 70%;height: 80px;margin: 0 auto;"></textarea>
