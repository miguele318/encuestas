		...
		<tr>
			<td style="background-color: #ecf0f1">
				<div style="color: #34495e; margin: 4% 10% 2%; text-align: justify; font-family: sans-serif;">
					<h1 style="color: rgb(206, 55, 48); margin: 0 0 7px;">Encuesta sobre X pagina</h1>
					<p style="margin: 2px; font-size: 15px">
						Hola querido usuario, queremos saber tu experimentada opinion respecto a la pagina </p><?= $this->fetch('content') ?> <p> para mejorar todo lo posible y prestar un mejor servicio.
					</p>
